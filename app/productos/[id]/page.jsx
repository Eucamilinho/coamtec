...
export default function DetalleProducto({ params }) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-2">
              <div
                className={`w-2 h-2 rounded-full ${producto.stock > 3 ? "bg-green-400" : "bg-red-500"}`}
              />
  ...
  onClick={() => {
    ...
    setItems([{ ...producto, precio: precioFinal, cantidad }])
    router.push("/checkout/rapido")
  }}
  className="w-full py-4 rounded-xl font-black text-lg bg-orange-500 text-white hover:bg-orange-400 transition flex items-center justify-center gap-2"
>
  <Zap size={20} />
  Comprar ahora
</button>
              ...
              >
                <Heart
                  size={16}
                  className={enWishlist ? "fill-green-400" : ""}
                />
        ...
        {producto.video_tiktok && <VideoTikTok url={producto.video_tiktok} />}
          ...
          <div className="md:hidden flex flex-col items-center gap-5 py-6 w-full">
            ...
            <div className="text-center">
              ...
              <p className="text-zinc-500 text-xs">
                Toca el botón para ver el video del producto
              </p>
            </div>
            href={url}
            target="_blank" rel="noopener noreferrer" className="w-full bg-black
            border border-zinc-700 text-white font-bold py-3 rounded-xl flex
            items-center justify-center gap-2 hover:bg-zinc-900 transition"
            <a>
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white">
                <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z" />
              </svg>
