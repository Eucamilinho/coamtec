    ...
    return (
      <div className="min-h-screen bg-white dark:bg-zinc-950 flex items-center justify-center pt-20">
        <div className="text-center">
          <h1 className="text-3xl font-black text-zinc-800 dark:text-white mb-4">Tu carrito está vacío</h1>
          ...
          <div className="lg:col-span-2">
            ...
            {paso === 1 && (
              <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-1 md:col-span-2">
                    <label className="text-zinc-500 text-sm">Referencia o indicaciones</label>
                    <textarea
                      name="referencia"
            ...
            {paso === 2 && (
              <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 flex flex-col gap-4">
                ...
                <div className="bg-green-400/5 border border-green-400/20 rounded-xl p-4 flex flex-col gap-2 mt-2">
                  <p className="text-zinc-700 dark:text-zinc-300 text-sm font-medium">Resumen del pedido</p>
            ...
            <div className="flex justify-between mt-6">
              ...
              {paso < PASOS.length - 1 ? (
                ...
                <button
                  onClick={() => alert("¡Aquí irá MercadoPago!")}
                  className="bg-green-400 text-black font-black px-8 py-3 rounded-xl hover:bg-green-300 transition flex items-center gap-2"
                >
                  <Lock size={16} />
                  Confirmar pedido
                </button>
