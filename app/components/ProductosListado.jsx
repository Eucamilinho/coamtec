          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {productosFiltrados.map((producto) => {
              ...
              return (
                ...
                >
                  <article
                    className={`bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 flex flex-col gap-3 relative transition shadow-sm hover:shadow-lg hover:-translate-y-0.5 duration-300 ${
                      producto.stock === 0
          ...
          <div className="flex flex-col gap-4">
            {productosFiltrados.map((producto) => {
              ...
              return (
                <article
                  key={producto.id}
                  className={`bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 flex gap-6 items-center transition group shadow-sm hover:shadow-lg hover:-translate-y-0.5 duration-300 ${
                    producto.stock === 0
                      ? "opacity-70"
                      : ""
                  }`}
