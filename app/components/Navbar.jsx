...
<div className="hidden md:flex items-center gap-1 mr-1">
  <a href="https://instagram.com/coamtec" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
    className="w-10 h-10 md:w-11 md:h-11 flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:text-[#E1306C] dark:hover:text-[#E1306C] transition">
  ...
  <a href="https://facebook.com/coamtec" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
    className="w-10 h-10 md:w-11 md:h-11 flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:text-[#1877F2] dark:hover:text-[#1877F2] transition">
    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
    </svg>
  </a>
  <a href="https://tiktok.com/@coamtec" target="_blank" rel="noopener noreferrer" aria-label="TikTok"
    className="w-10 h-10 md:w-11 md:h-11 flex items-center justify-center text-zinc-600 dark:text-zinc-400 hover:text-white dark:hover:text-white transition">
    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
