              ...
              >
                ...
                <div className="flex gap-3 items-start">
                  ...
                  <button
                    ...
                    className="text-zinc-400 hover:text-red-400 transition flex-shrink-0 p-1"
                  >
                    <Trash2 size={16} />
                  </button>
                </div>
...
function CantidadControl({ item }) {
  ...
  return (
    <>
      <button onClick={restarCantidad} className="text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition p-1">
        <Minus size={14} />
      </button>
      <span className="text-zinc-900 dark:text-white font-bold w-6 text-center text-sm">{item.cantidad}</span>
      <button onClick={sumarCantidad} className="text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition p-1">
        <Plus size={14} />
      </button>
    </>
  )
